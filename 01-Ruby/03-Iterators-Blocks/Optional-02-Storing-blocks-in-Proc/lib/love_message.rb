def tell(who, &message_blk)
  new_message = message_blk.call
  "#{who}, #{new_message}!" # TODO: return message addressed to who
end

def tell_mum(&message_blk)
  mum_message = message_blk.call # TODO: return message addressed to your mum
  "mum, #{mum_message}!" # => Should call #tell of course
end
...
def tell_mum_with_proc(message_blk)
  mum_message = message_blk.call # TODO: return message addressed to your mum
  "mum, #{mum_message}!" # TODO: return message addressed to your mum
