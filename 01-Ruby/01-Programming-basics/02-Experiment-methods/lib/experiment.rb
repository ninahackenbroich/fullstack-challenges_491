...
def belongs_to?(a_string, a_word)
  a_string.include? a_word # TODO: return true if a_string contains a_word
...
def divisible_by_two?(an_integer)
  an_integer.even? # TODO: return true if an_integer is divisible by 2
  # example: divisible_by_two?(6) => true
end

def random_subset(an_array, sample_size)
  an_array.sample(sample_size) # TODO: return a random subset of an_array with size sample_size
  # example: random_subset(('a'..'z').to_a, 4) => ["u", "q", "l", "t"]
end

def randomize(an_array)
  an_array.shuffle # TODO: return a randomized copy of an_array
  # example: randomize([1, 2, 3, 4]) => [2, 1, 4, 3]
end

def ascending_order(an_array)
  an_array.sort # TODO: return a copy of an_array with elements in ascending order
